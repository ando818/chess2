  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!ionicGlobal.config.getBoolean('_testing')) {
          Promise.resolve().then(function () { return require('./index-3a696c5a.js'); }).then((module) => module.startTapClick(ionicGlobal.config));
        }
        ...
        if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
          ...
          Promise.resolve().then(function () { return require('./input-shims-18be818b.js'); }).then((module) => module.startInputShims(ionicGlobal.config, platform));
        }
