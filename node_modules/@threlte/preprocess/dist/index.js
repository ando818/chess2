...
const preprocessMarkup = (content, transformOptions) => {
    const prefix = (transformOptions === null || transformOptions === void 0 ? void 0 : transformOptions.prefix) ? `${transformOptions === null || transformOptions === void 0 ? void 0 : transformOptions.prefix}.` : 'T.';
    ...
    walk(ast, {
        enter(node, parent, key, index) {
            ...
            if (node.type === 'ImportDeclaration') {
                ...
                addImport(documentImportMap, node.source.value, node.specifiers
            ...
            if (node.type === 'Element' || node.type === 'InlineComponent') {
                ...
                const isInExtensions = (transformOptions === null || transformOptions === void 0 ? void 0 : transformOptions.extensions) &&
