...
// node_modules/@ionic/core/dist/esm-es5/ios.transition-4a0deed6.js
var DURATION = 540;
...
var animateBackButton = function(t, e, a, o, r, n) {
  ...
  A.addElement(h);
  b.addElement(T);
  b.beforeStyles({ "transform-origin": "".concat(f, " center") }).beforeAddWrite(function() {
  ...
  A.beforeStyles({ "transform-origin": "".concat(d, " center") }).keyframes(g);
  t.addAnimation([b, A]);
};
...
var iosTransitionAnimation = function(t, e) {
  ...
  try {
    ...
    var b = createAnimation();
    g.addElement(d).duration(((a = e.duration) !== null && a !== void 0 ? a : 0) || DURATION).easing(e.easing || o).fill("both").beforeRemoveClass("ion-page-invisible");
    ...
    if (!p && y.length === 0 && u.length === 0) {
      b.addElement(d.querySelector(":scope > .ion-page, :scope > ion-nav, :scope > ion-tabs"));
    } else {
      b.addElement(p);
      b.addElement(u);
    }
    g.addAnimation(b);
    if (v) {
      b.beforeClearStyles([r]).fromTo("transform", "translateX(".concat(f, ")"), "translateX(".concat(i, ")")).fromTo(r, l, 1);
    } else {
    ...
    var C = createLargeTitleTransition(g, c, v, d, m), k = C.forward, w = C.backward;
...
@ionic/core/dist/esm-es5/ios.transition-4a0deed6.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
*/
//# sourceMappingURL=chunk-DI2GE425.js.map
