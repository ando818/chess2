...
var enableScrollAssist = (componentEl, inputEl, contentEl, footerEl, keyboardHeight, disableClonedInput = false) => {
  let coord;
  const touchStart = (ev) => {
...
var jsSetFocus = async (componentEl, inputEl, contentEl, footerEl, keyboardHeight, disableClonedInput = false) => {
...
var hasPointerMoved = (threshold, startCoord, endCoord) => {
...
var enableScrollPadding = (keyboardHeight) => {
  const doc = document;
  const onFocusin = (ev) => {
...
var setScrollPadding = (input, keyboardHeight) => {
  var _a, _b;
...
var startInputShims = (config, platform) => {
  const doc = document;
...
@ionic/core/components/input-shims.js:
   ...
   *)
*/
//# sourceMappingURL=input-shims-XHGF7KKS.js.map
